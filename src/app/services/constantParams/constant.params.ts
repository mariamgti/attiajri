...
export class ConstantParams {
  public BaseUrlWsClient = 'http://localhost:8083/Internship/services/rest/';
 // public BaseUrlWsApiBanque = 'https://www.attijarimobile.homo.com.tn/';

 public BaseUrlWsApiBanque = 'http://localhost:8083/Internship/';
 ...
 public BaseUrlWsElargissementAttijariMob = 'http://localhost:8083/Internship/services/rest/'
